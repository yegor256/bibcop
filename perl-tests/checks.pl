...
check_fails($f, ('title' => 'A missed space after the bracket (hello)you!'));
check_fails($f, ('title' => 'A missing space after,the comma'));
...
check_fails($f, ('title' => 'Either You Love Me, or... Not'));
check_fails($f, ('title' => 'Either You Love Me, or ...Not'));
...
check_fails($f, ('author' => 'Jeff, John, Sarah, Mary'));
check_fails($f, ('author' => 'Smith, John, Doe, Jane'));
...
check_passes($f, ('author' => 'von Bos, Klaus'));
